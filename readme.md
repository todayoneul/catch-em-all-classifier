...
실험을 통해 얻은 각 모델의 최종 평가 지표는 다음과 같습니다. 상세 데이터는 `./reports/` 폴더 내의 CSV 파일에서 확인할 수 있습니다. 전반적으로 **Vision Transformer(ViT)** 기반 모델들이 전통적인 CNN인 ResNet50보다 우수한 성능을 보여주었습니다.
